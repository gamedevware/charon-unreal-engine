...
#include "ENumberTestEntityMultiPickList8Bit.generated.h"

/**
  * Enumeration based on int32. Flags, Used in Schemas: NumberTestEntity.
  */
UENUM(BlueprintType, meta = (Bitflags, UseEnumValuesAsMaskValuesInEditor = "true"))
enum class ENumberTestEntityMultiPickList8Bit : uint8 {
...
ENUM_CLASS_FLAGS(ENumberTestEntityMultiPickList8Bit);

/** Implements variant type traits for enumeration type. */
template<> struct TVariantTraits<ENumberTestEntityMultiPickList8Bit>
{
