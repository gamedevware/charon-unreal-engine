...
DECLARE_LOG_CATEGORY_EXTERN(LogUAllTypesTestVoidFormulaFormula, Log, All);

#include "UAllTypesTestVoidFormulaFormula.generated.h"

/**
  * Formula Signature: () -> void
  */
UCLASS(BlueprintType)
class TESTDATA_API UAllTypesTestVoidFormulaFormula : public UObject
{
	GENERATED_BODY()
