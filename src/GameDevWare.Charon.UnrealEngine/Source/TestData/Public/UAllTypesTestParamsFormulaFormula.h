...
DECLARE_LOG_CATEGORY_EXTERN(LogUAllTypesTestParamsFormulaFormula, Log, All);

#include "UAllTypesTestParamsFormulaFormula.generated.h"

/**
  * Formula Signature: (int intParam, string stringParam, bool boolParam, UObject objectParam) -> int
  */
UCLASS(BlueprintType)
class TESTDATA_API UAllTypesTestParamsFormulaFormula : public UObject
{
	GENERATED_BODY()
...
public:
	...
	int32 Invoke(int32 IntParam, FString StringParam, bool BoolParam, UObject* ObjectParam) const;
