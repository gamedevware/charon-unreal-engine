...
#include "ENumberTestEntityPickList16Bit.generated.h"

/**
  * Enumeration based on int32. Used in Schemas: NumberTestEntity.
  */
UENUM(BlueprintType)
enum class ENumberTestEntityPickList16Bit : uint8 {
...
template<> struct TVariantTraits<ENumberTestEntityPickList16Bit>
{
