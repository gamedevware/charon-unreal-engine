...
#include "URecursiveEntity.generated.h"


/**
  * Recursive Entity with Text id.
  */
UCLASS(BlueprintType)
class TESTDATA_API URecursiveEntity : public UGameDataDocument
{
	GENERATED_BODY()
...
public:
	...
	FString Id;
	/**
	  * Title property of Text type. Not Null.
	  */
	UPROPERTY(BlueprintReadOnly, VisibleAnywhere)
	FString Title;
	/**
	  * Children property of Document Collection type. Not Null.
	  */
	UPROPERTY(BlueprintReadOnly, VisibleAnywhere)
	TMap<FString,URecursiveEntity*> Children;
};
