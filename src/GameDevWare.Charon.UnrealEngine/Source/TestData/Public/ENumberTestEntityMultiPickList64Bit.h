...
enum class ENumberTestEntityMultiPickList64Bit : uint8 {
...
ENUM_CLASS_FLAGS(ENumberTestEntityMultiPickList64Bit);

/** Implements variant type traits for enumeration type. */
template<> struct TVariantTraits<ENumberTestEntityMultiPickList64Bit>
{
