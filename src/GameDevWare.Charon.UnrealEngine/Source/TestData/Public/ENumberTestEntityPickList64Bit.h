...
#include "ENumberTestEntityPickList64Bit.generated.h"

/**
  * Enumeration based on int64. Used in Schemas: NumberTestEntity.
  */
UENUM(BlueprintType)
enum class ENumberTestEntityPickList64Bit : uint8 {
...
template<> struct TVariantTraits<ENumberTestEntityPickList64Bit>
{
