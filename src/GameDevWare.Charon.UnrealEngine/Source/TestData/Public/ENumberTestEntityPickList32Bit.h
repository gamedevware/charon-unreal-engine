...
#include "ENumberTestEntityPickList32Bit.generated.h"

/**
  * Enumeration based on int32. Used in Schemas: NumberTestEntity.
  */
UENUM(BlueprintType)
enum class ENumberTestEntityPickList32Bit : uint8 {
...
template<> struct TVariantTraits<ENumberTestEntityPickList32Bit>
{
