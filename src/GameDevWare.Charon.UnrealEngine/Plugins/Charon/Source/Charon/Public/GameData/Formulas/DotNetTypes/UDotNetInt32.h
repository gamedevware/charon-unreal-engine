...
public:
	...
	static FNumericProperty* GetLiteralProperty()
	{
		...
		return LiteralProperty = CastFieldChecked<FNumericProperty>(StaticClass()->FindPropertyByName(GET_MEMBER_NAME_CHECKED(UDotNetInt32, __Literal)));
	}
	static FArrayProperty* GetArrayProperty()
	{
		...
		return ArrayProperty = CastFieldChecked<FArrayProperty>(StaticClass()->FindPropertyByName(GET_MEMBER_NAME_CHECKED(UDotNetInt32, __ArrayLiteral)));
	}
};